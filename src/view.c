...
c8a87:
    ...
    { uint16_t tmp_ = x - l0080; flags = (flags & ~(FLAG_Z|FLAG_N|FLAG_C)) | (tmp_ == 0 ? FLAG_Z : 0) | ((uint8_t)tmp_ & FLAG_N) | (x >= l0080 ? FLAG_C : 0); }
    //     bcc c8aa3
...
c8cdb:
    ...
    { uint16_t tmp_ = a - l0080; flags = (flags & ~(FLAG_Z|FLAG_N|FLAG_C)) | (tmp_ == 0 ? FLAG_Z : 0) | ((uint8_t)tmp_ & FLAG_N) | (a >= l0080 ? FLAG_C : 0); }
    //     bcc c8c95
    if (!(flags & FLAG_C)) goto c8c95;
c8cf1:
    // c8cf1:
...
static void sub_c9aa9(void) {
    ...
    l003b = y;
    //     inc l006e
    edit_buffer_unpacked_flag++; flags = (flags & ~(FLAG_Z|FLAG_N)) | (edit_buffer_unpacked_flag == 0 ? FLAG_Z : 0) | (edit_buffer_unpacked_flag & FLAG_N);
...
static void write_line_back_to_document(void) {
    ...
    //     lda l006e
    //     beq ca93a
    if (edit_buffer_unpacked_flag == 0) goto ca93a;
    //     lda current_line_ptr
    //     sta tmp4
    //     lda current_line_ptr+1
    //     sta tmp5
