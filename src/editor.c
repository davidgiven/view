...
caa57:
    ...
    a = sbc(&flags, a, ((uint8_t*)&tmp45)[0]);
    //     tax (6482)
    x = a;
    //     lda ((uint8_t*)&tmp23)[1] (6483)
    a = ((uint8_t*)&tmp23)[1];
    //     sbc ((uint8_t*)&tmp45)[1] (6484)
    a = sbc(&flags, a, ((uint8_t*)&tmp45)[1]);
    //     beq caa65 (6485)
    if (!(flags & FLAG_Z))
    {
        x = 0xff;
