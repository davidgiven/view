...
- **replace_cmd** → scan_document_for_next_line, cmd_err_no_string, cmd_err_no_target, draw_prompt_characters, enter_editor_mode, esc_key, move_cursor_to_address, read_char, show_memory_full_error, redraw_and_write_back, setup_area_pointers, process_cli_command, check_area_memory [a, flags, print_xpos, x, y]
...
- **compute_space_available** → compute_bytes_free, compute_space_common [a, tmp8, tmp9, x, y]
...
- **microspace_word_processor** → print_char, print_char_x_times, print_vertical_space, emit_microspacing_spaces, convert_char_for_printing, divide_for_microspacing [a, flags, l0021, l0039, l0042, l0043, l0044, l0045, l0046, l0047, l0048, l0080, l0083, line_spacing, microspacing_flag, output_buffer, ram, ruler_right_stop, tmp0, tmp1, tmp8, tmp9, x, y]
...
- **justify_edit_buffer** → get_line_length, process_char_for_output, divide_for_microspacing, wipe_buffer [a, flags, input_buffer, justifying_flag, l0039, l0042, l0043, l0044, l0045, l0046, l0081, l0082, l0084, output_buffer, print_xpos, ram, ruler_right_stop, tmp8, tmp9, x, y]
...
- **f0_format_block_key** → clamp_ptr6_to_document, show_memory_full_error, format_paragraph, write_line_back_to_document_safely [a, flags, l003d, l0073, x]
...
- **cf0_delete_block_key** → beep, clamp_ptr6_to_document, ensure_cr_at_document_top, clear_marks_1_2, move_cursor_to_address, reset_area_to_marks_1_2, adjust_area_pointers, write_line_back_to_document_safely [a, area_start_ptr, cursor_moved_flag, flags, y]
...
- **df_fmt_cmd** → process_header_footer_line [footer_text_maybe, x, y]
- **dh_fmt_cmd** → process_header_footer_line [header_text_maybe, x, y]
...
- **page_eject_fmt** → process_page_footer, render_new_page [a, flags, l0031]
...
- **divide_for_microspacing** [a, flags, l0046, tmp8, tmp9, x]
