...
label(0xA69C, "emit_to_gobuffer_callback")
...
subroutine(0x97b8, "evaluation_expression_from_fmt_cmd")
...
subroutine(0xA68C, "render_number_to_go_buffer",on_entry={"tmp9/tmp8":"16-bit number"})
subroutine(0xA6B2, "render_number_to_screen", on_entry={"YX": "16-bit number"})
subroutine(0xA6BA, "render_number_to_callback", on_entry={"tmp8/tmp9": "16-bit number", "YA": "callback"},)
...
subroutine(0xad81, "render_register", on_entry={"tmp7/tmp6":"pointer to register","a":"register name"})
subroutine(0xADA7, "render_date_time_to_go_buffer")
...
ldaaddr(0xB34F, "go_handler")
subroutine(0xB310, "write_hex_to_go_buffer")

label(0xB144, "decimal_table")
word(0xB144, 4)

ldaaddr(0xA6B6, "oswrch")
