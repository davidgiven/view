...
SRC_COMMON = src/view.c src/printing.c src/macro.c src/document.c src/editor.c src/cli.c src/io/screen_ncurses.c
SRC_INTERACTIVE = src/io/cli_readline.c
SRC_TEST = src/io/cli_stdio.c

OBJ_COMMON = $(addprefix $(OBJ_DIR)/, view.o printing.o macro.o document.o editor.o cli.o screen_ncurses.o)
OBJ_COMMON_TEST = $(addprefix $(OBJ_DIR)/, view.o printing.o macro.o document.o editor.o cli.o screen_ncurses_test.o)
...
bin/test_ruler: tests/test_ruler.c $(OBJ_DIR)/view_nomain.o $(OBJ_DIR)/cli.o $(OBJ_DIR)/printing.o $(OBJ_DIR)/macro.o $(OBJ_DIR)/document.o $(OBJ_DIR)/editor.o $(OBJ_DIR)/cli_stdio.o $(OBJ_DIR)/screen_ncurses.o
	mkdir -p bin
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)

bin/test_justify: tests/test_justify.c $(OBJ_DIR)/view_nomain.o $(OBJ_DIR)/cli.o $(OBJ_DIR)/printing.o $(OBJ_DIR)/macro.o $(OBJ_DIR)/document.o $(OBJ_DIR)/editor.o $(OBJ_DIR)/cli_stdio.o $(OBJ_DIR)/screen_ncurses.o
	mkdir -p bin
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)

bin/test_ruler_index: tests/test_ruler_index.c $(OBJ_DIR)/view_nomain.o $(OBJ_DIR)/cli.o $(OBJ_DIR)/printing.o $(OBJ_DIR)/macro.o $(OBJ_DIR)/document.o $(OBJ_DIR)/editor.o $(OBJ_DIR)/cli_stdio.o $(OBJ_DIR)/screen_ncurses.o
	mkdir -p bin
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
